...
class __TwigTemplate_1310e3f3d7a3a4c70152af2d8bb0cec2 extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}Erreur 403 Accès non autorisé{% endblock %}
...
{% block body %}
    <section class=\"d-flex align-items-center mb-5 justify-content-center flex-column\">
        <h1 class=\"mt-5 text-center\">Accès Refusé</h1>
        <figure class=\"col-12 text-center\">
            <img class=\"w-50 my-5 rounded\" src=\"{{ asset('build/logo_denied.jpeg') }}\"  alt=\"Logo denied\">
        </figure>
        <p>
...
{% endblock %}
", "@Twig/Exception/error403.html.twig", "/home/vador/Projects/Symfony/Pro/orleans-php-2003-project-loireetorleans/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
