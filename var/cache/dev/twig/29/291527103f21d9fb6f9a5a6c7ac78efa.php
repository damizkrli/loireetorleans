...
class __TwigTemplate_b2a8cd621b597a59b515ed0bc91ae8fe extends Template
{
    private $source;
    private $macros = [];
 ...
 ";
    ...
    <div class=\"form w-100\">
        ...
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["document"]) || array_key_exists("document", $context) ? $context["document"] : (function () { throw new RuntimeError('Variable "document" does not exist.', 10, $this->source); })()), "name", [], "any", false, false, false, 10), "html", null, true);
        echo "</h1>
        ";
        // line 11
...
";
    ...
    {
        return array (  126 => 14,  120 => 11,  116 => 10,  112 => 8,  102 => 7,  89 => 5,  79 => 4,  60 => 3,  37 => 1,);
    }
...
{% block title %}Loire&Orléans | Modifier le document{% endblock %}
 {% block stylesheets %}
     {{ encore_entry_link_tags('addDocument') }}
 {% endblock %}
{% block body %}
<section class=\"d-md-flex align-items-center mb-5\">
    <div class=\"form w-100\">
        <h1 class=\"text-center my-4\">Modifier {{ document.name }}</h1>
        {{ include('document/_form.html.twig', {'button_label': 'Modifier'}) }}

        <div class=\"d-flex justify-content-center\">
            <a class=\"btn btn-lg btn-primary my-4\" href=\"{{ path('document_index') }}\">Retour aux documents</a>
...
", "document/edit.html.twig", "/home/vador/Projects/Symfony/Pro/orleans-php-2003-project-loireetorleans/templates/document/edit.html.twig");
    }
}
