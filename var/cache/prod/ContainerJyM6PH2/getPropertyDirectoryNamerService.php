...
return $this->services['Vich\\UploaderBundle\\Naming\\PropertyDirectoryNamer'] = new \Vich\UploaderBundle\Naming\PropertyDirectoryNamer(($this->privates['property_accessor'] ?? $this->load('getPropertyAccessorService.php')), ($this->privates['Vich\\UploaderBundle\\Util\\Transliterator'] ?? $this->load('getTransliteratorService.php')));
